...
public class Last5Matches_ {
     ...
     * @param goalsAgainst
     */
    public Last5Matches_(String forme, String att, String def, int goalsAgainst, double goalsAvg, double goalsAgainstAvg, int goals) {
        super();
        this.forme = forme;
        this.att = att;
        this.def = def;
